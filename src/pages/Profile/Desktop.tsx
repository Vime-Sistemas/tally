    ...
    <div className="min-h-screen bg-zinc-50/50 p-6 md:p-10">
      <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-zinc-200">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">Configurações da Conta</h1>
            <p className="text-sm text-zinc-500 mt-1">Gerencie seus dados pessoais e preferências do sistema.</p>
          </div>
          <div className="flex items-center gap-3">
             ...
             <Button 
                ...
                className={cn(
                  "transition-all",
                  isDirty ? "bg-zinc-900 hover:bg-zinc-800" : "bg-zinc-200 text-zinc-400 hover:bg-zinc-200 cursor-not-allowed"
                )}
              >
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <Tabs defaultValue="general" className="flex flex-col lg:flex-row gap-10" orientation="vertical">
            ...
            <aside className="lg:w-64 flex-shrink-0 space-y-8">
              ...
              <div className="flex items-center gap-3 px-2">
                ...
                <div className="overflow-hidden">
                  <p className="text-sm font-medium text-zinc-900 truncate">{user?.name || "Usuário"}</p>
              ...
              <div className="px-3">
                <div className="p-3 bg-blue-50 rounded-lg border border-blue-100 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-blue-700">Plano PRO</span>
                    <Badge variant="secondary" className="bg-white text-blue-600 hover:bg-white text-[10px] h-5">ATIVO</Badge>
                  </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Tab: General */}
              <TabsContent value="general" className="space-y-6 mt-0 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-6">
                  <div>
                    <h2 className="text-lg font-medium text-zinc-900">Informações Pessoais</h2>
                    <p className="text-sm text-zinc-500">Atualize sua foto e detalhes pessoais aqui.</p>
                  </div>
                  <Separator />
                  ...
                  <div className="grid gap-6 max-w-2xl">
                    <div className="grid gap-2">
                      ...
                      <Input id="name" className="bg-white" {...form.register("name")} />
                      <p className="text-[11px] text-zinc-500">Este é o nome que aparecerá no seu perfil e emails.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="grid gap-2">
                        ...
                        <div className="relative">
                          ...
                          <Input id="email" className="pl-9 bg-zinc-50 text-zinc-500" {...form.register("email")} disabled />
                        </div>
                      </div>
                      <div className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                      ...
                      >
                        {form.watch("coverImage") ? (
                          <img src={form.watch("coverImage") || ""} alt="Capa" className="w-full h-full object-cover" />
                        ) : (
                          <div className="flex flex-col items-center gap-2 text-zinc-400">
                            <Camera className="h-6 w-6" />
                            <span className="text-xs">Clique para alterar a capa</span>
                          </div>
                        )}
              ...
              {/* Tab: Business */}
              <TabsContent value="business" className="space-y-6 mt-0 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-6">
                  <div>
                    <h2 className="text-lg font-medium text-zinc-900">Perfil da Empresa</h2>
                    <p className="text-sm text-zinc-500">Gerencie as informações da sua entidade jurídica.</p>
                  </div>
                  <Separator />

                  <div className="grid gap-6 max-w-2xl">
                    <div className="grid gap-2">
                      <Label htmlFor="businessName">Razão Social / Nome Fantasia</Label>
                      <div className="relative">
                        <Building2 className="absolute left-3 top-2.5 h-4 w-4 text-zinc-400" />
                        <Input id="businessName" className="pl-9 bg-white" {...form.register("businessName")} />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="grid gap-2">
                        ...
                        <div className="relative">
                          ...
                          <Input id="businessWebsite" className="pl-9 bg-white" placeholder="https://" {...form.register("businessWebsite")} />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* Tab: Settings */}
              <TabsContent value="settings" className="space-y-6 mt-0 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-6">
                  <div>
                    <h2 className="text-lg font-medium text-zinc-900">Preferências do Sistema</h2>
                    <p className="text-sm text-zinc-500">Personalize sua experiência de uso.</p>
                  </div>
                  <Separator />
                      ...
                      >
                        <Label
                          ...
                          className={cn(
                            ...
                            form.watch("menuPreference") === "header" ? "border-zinc-900 bg-zinc-50/50" : "border-zinc-200"
                          )}
                        >
                          <RadioGroupItem value="header" id="header" className="sr-only" />
                          ...
                          <span className="block w-full text-center font-medium text-sm">Menu Superior</span>
                        </Label>
                        ...
                        <Label
                          ...
                          className={cn(
                            "flex flex-col items-center justify-between rounded-xl border-2 border-muted bg-transparent p-4 hover:bg-zinc-50 cursor-pointer transition-all",
                            form.watch("menuPreference") === "sidebar" ? "border-zinc-900 bg-zinc-50/50" : "border-zinc-200"
                          )}
                        >
                          ...
                          <span className="block w-full text-center font-medium text-sm">Menu Lateral</span>
                        </Label>
                      </RadioGroup>
                    </div>
                    ...
                    <div className="pt-4">
                      ...
                      <div className="rounded-lg border border-red-100 bg-red-50 p-4 flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-red-700">Esta ação é permanente e não pode ser desfeita.</p>
                        </div>
                        <Button variant="destructive" size="sm" className="bg-white text-red-600 border border-red-200 hover:bg-red-50 hover:text-red-700 shadow-sm">
                          Excluir
                        </Button>
                      </div>
                    </div>
